...
import org.springframework.samples.mvc.messageconverters.MessageConvertersController;
...
public class MessageConvertersControllerTests extends AbstractContextControllerTests {
	...
	/* testedClasses: MessageConvertersController */
	/*
	...
	*/
	...
	@Test
	public void writeXmlOutputNotNull() throws InvocationTargetException {

		// Arrange
		MessageConvertersController objectUnderTest =
			((MessageConvertersController)Reflector.getInstance(
				"org.springframework.samples.mvc.messageconverters.MessageConvertersController"));

		// Act
		org.springframework.samples.mvc.messageconverters.JavaBean retval = objectUnderTest.writeXml();

		// Assert result
		Assert.assertNotNull(retval);
		Assert.assertEquals("apple", Reflector.getInstanceField(retval, "fruit"));
		Assert.assertEquals("bar", Reflector.getInstanceField(retval, "foo"));
	}
	...
	*/
	...
	@Test
	public void writeStringOutputNotNull() throws InvocationTargetException {
		...
		// Act
		String retval = objectUnderTest.writeString();

		// Assert result
		Assert.assertEquals("Wrote a string", retval);
	}
	...
	*/
	...
	@Test
	public void writeJsonOutputNotNull() throws InvocationTargetException {
		...
		// Act
		org.springframework.samples.mvc.messageconverters.JavaBean retval = objectUnderTest.writeJson();
	...
	*/
	...
	@Test
	public void readStringInputNotNullOutputNotNull() throws InvocationTargetException {
		...
		// Act
		String retval = objectUnderTest.readString(string);

		// Assert result
		Assert.assertEquals("Read string \'    \'", retval);
	}
